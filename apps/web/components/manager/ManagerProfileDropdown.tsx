  ...
  return (
    <div className="relative" ref={dropdownRef}>
      ...
      <button
        ...
        className="flex items-center gap-2.5 p-1.5 pr-2.5 rounded-xl border border-slate-200 bg-white hover:bg-slate-50 transition-all text-left shadow-2xs cursor-pointer focus:outline-none focus:ring-2 focus:ring-[#023E8A]/20"
      ...
      >
        <div className="relative">
          {user?.avatar ? (
            ...
            <div className="h-8 w-8 rounded-lg bg-gradient-to-tr from-[#023E8A] to-indigo-600 text-white font-bold text-xs flex items-center justify-center shadow-xs">
        ...
        <div className="absolute right-0 mt-2 w-64 rounded-2xl bg-white border border-slate-200 shadow-xl py-2 z-50 animate-in fade-in zoom-in-95 duration-150">
          ...
          <div className="px-4 py-2.5 border-b border-slate-100 flex items-center gap-3">
            {user?.avatar ? (
              ...
              <div className="h-9 w-9 rounded-xl bg-gradient-to-tr from-[#023E8A] to-indigo-600 text-white font-bold text-xs flex items-center justify-center shrink-0">
                {user?.name?.slice(0, 2).toUpperCase() || "SP"}
              </div>
            )}
          ...
          <div className="flex items-center gap-4 p-3 bg-slate-50 border border-slate-200 rounded-xl">
            <div className="relative">
              {activeAvatarPreview ? (
                ...
                <div className="h-16 w-16 rounded-2xl bg-gradient-to-tr from-[#023E8A] to-indigo-600 text-white font-bold text-lg flex items-center justify-center shadow-md">
                  {user?.name?.slice(0, 2).toUpperCase() || "SP"}
                </div>
              )}
              <span className="absolute -top-1 -right-1 bg-[#023E8A] text-white p-1 rounded-full shadow-xs">
                ...
                return (
                  <button
                    ...
                    className={`p-1 rounded-xl border transition-all hover:scale-105 cursor-pointer ${
                      isSelected
                        ? "border-[#023E8A] ring-2 ring-[#023E8A]/30 bg-blue-50"
