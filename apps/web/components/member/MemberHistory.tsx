      ...
      <header className="px-4 py-3 bg-white border-b border-slate-200 shrink-0 space-y-2.5">
        <div className="flex items-center justify-between">
          ...
          <Button
            ...
            className="text-xs bg-[#1E4ED8] hover:bg-[#1D40B0] py-1 px-3"
          >
        ...
        {conversations.length > 3 && (
          <div className="relative">
            ...
            <input
              ...
              className="w-full pl-8 pr-3 py-1.5 bg-slate-50 border border-slate-200 rounded-lg text-xs placeholder:text-slate-400 focus:outline-none focus:border-[#1E4ED8] focus:bg-white transition-colors"
            />
          </div>
        )}
      </header>
      ...
      <div className="flex-1 overflow-y-auto p-3 space-y-2.5">
        {isLoading ? (
          ...
          <div className="text-center py-12 px-4">
            <div className="inline-flex items-center justify-center h-11 w-11 rounded-full bg-blue-50 text-[#1E4ED8] mb-2.5">
            ...
            <Button
              ...
              size="sm"
              onClick={onStartNewChat}
              className="mt-3 text-xs bg-[#1E4ED8] hover:bg-[#1D40B0]"
            >
              Mulai Chat Pertama
            </Button>
          </div>
            ...
            return (
              <div
                ...
                className={`group p-3 rounded-xl border transition-all cursor-pointer flex items-center justify-between gap-2.5 ${
                  isSelected
                    ? "bg-blue-50/70 border-[#1E4ED8] shadow-xs"
                ...
                <div className="flex items-center gap-1 shrink-0">
                  ...
                  <ChevronRight
                    className={`h-4 w-4 transition-colors ${
                      isSelected ? "text-[#1E4ED8]" : "text-slate-300 group-hover:text-slate-500"
                    }`}
                  />
                </div>
              </div>
