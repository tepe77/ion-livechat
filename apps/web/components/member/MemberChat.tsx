    ...
    <div className="flex flex-col h-full min-h-0 w-full bg-white sm:rounded-2xl shadow-sm sm:border border-slate-200 overflow-hidden">
      ...
      <header className="flex items-center justify-between px-5 py-3.5 bg-white border-b border-slate-200 shrink-0 z-10">
        <div className="flex items-center gap-3.5">
          <div className="relative">
            <div className="flex items-center justify-center h-11 w-11 rounded-2xl bg-gradient-to-tr from-[#0F2B5B] to-[#1E4ED8] text-white font-semibold shadow-xs">
          ...
          <div>
            <div className="flex items-center gap-2">
              ...
              <span className="text-[10px] font-semibold px-2 py-0.5 rounded-md bg-blue-50 text-[#1E4ED8] border border-blue-100 hidden sm:inline">
                Dukungan Teknis ISP
              </span>
            </div>
      ...
      <div className="flex-1 overflow-y-auto p-4 sm:p-6 space-y-4 bg-slate-50/60">
        ...
        <div className="max-w-xl mx-auto p-4 rounded-2xl bg-white border border-slate-200 shadow-2xs text-center space-y-2 mb-4">
          <div className="inline-flex items-center justify-center h-10 w-10 rounded-xl bg-blue-50 text-[#1E4ED8]">
          ...
          <div className="max-w-xl mx-auto">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
              <button
                ...
                className="text-left p-2.5 rounded-xl border border-slate-200 bg-white hover:border-[#1E4ED8] hover:bg-blue-50/50 text-xs text-slate-700 transition-all cursor-pointer"
              >
            ...
            >
              ...
              <div
                className={cn(
                  ...
                  isMe
                    ? "bg-[#1E4ED8] text-white rounded-br-xs font-normal"
        ...
        {isAgentTyping && (
          <div className="flex items-center gap-2 text-xs text-slate-500 bg-white border border-slate-200 rounded-full px-3.5 py-1.5 w-fit shadow-xs animate-pulse">
            <span className="h-1.5 w-1.5 rounded-full bg-[#1E4ED8] animate-bounce" />
            <span className="h-1.5 w-1.5 rounded-full bg-[#1E4ED8] animate-bounce [animation-delay:0.2s]" />
            <span className="h-1.5 w-1.5 rounded-full bg-[#1E4ED8] animate-bounce [animation-delay:0.4s]" />
          ...
          <div className="flex flex-col sm:flex-row items-center justify-between gap-3 py-1.5 px-1">
            ...
            <div className="flex items-center gap-2 flex-wrap justify-center">
              ...
              <Button
                ...
                className="text-xs bg-[#1E4ED8] hover:bg-[#1D40B0] font-semibold shadow-xs cursor-pointer"
              >
                Mulai Chat Baru
              </Button>
            </div>
          ...
          <form onSubmit={handleSend} className="flex items-center gap-2 sm:gap-3">
            ...
            <div className="relative" ref={attachmentMenuRef}>
              ...
              <Button
                ...
                className={cn(
                  "text-slate-500 hover:text-[#1E4ED8] hover:bg-blue-50 shrink-0 h-10 w-10 rounded-xl transition-all",
            ...
            <input
              ...
              className="flex-1 rounded-xl border border-slate-300 bg-slate-50 px-4 py-2.5 text-xs sm:text-sm text-slate-900 placeholder:text-slate-400 focus:border-[#1E4ED8] focus:bg-white focus:outline-none focus:ring-1 focus:ring-[#1E4ED8] transition-colors"
            />
            ...
            <Button
              ...
              className="rounded-xl h-10 w-10 shrink-0 bg-[#1E4ED8] hover:bg-[#1D40B0] shadow-xs"
              title="Kirim pesan"
            >
